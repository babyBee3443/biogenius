...
const renderBlock = (block: Block) => {
    switch (block.type) {
        ...
        case 'divider': return <DividerBlockRenderer key={block.id} block={block as Extract<Block, { type: 'divider' }>} />;
            ...
            if (storedData) {
                ...
                try {
                    ...
                    if (parsedData.previewType === 'article' || parsedData.previewType === 'page') {
                        const item = parsedData as Partial<ArticleData> | Partial<PageDataType>;
                        if (typeof item.title !== 'string' || !Array.isArray(item.blocks)) {
                         ...
                         const item = parsedData as Partial<NoteData>;
                         if (typeof item.title !== 'string' || !Array.isArray(item.contentBlocks)) {
