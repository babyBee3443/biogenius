...
import { ArrowLeft, Eye, Loader2, Save, Upload, BookCopy, Tag, AlertTriangle } from "lucide-react";
            ...
            {/* Main Content Area */}
             <div className="flex flex-1 overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    {/* TODO: Fetch categories dynamically or use a predefined list */}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="Etiketleri virgülle ayırın (örn: hücre, dna, organel)"
                                    />
                                </div>
                 ...
                 {/* Right Sidebar (Optional: Could add metadata, related notes link etc.) */}
                 {/*
