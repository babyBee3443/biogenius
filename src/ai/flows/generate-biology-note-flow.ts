...
const ImageBlockSchema = BaseBlockSchema.extend({
  ...
  url: z.string().url().describe("URL of a relevant image. If a specific image isn't known, use a placeholder like 'https://picsum.photos/seed/ai-placeholder/800/400'. Provide a descriptive seed like 'ai-cell-division' or 'ai-photosynthesis-diagram' in the picsum URL if using a placeholder. Ensure this is a valid URL format."),
...
const VideoBlockSchema = BaseBlockSchema.extend({
  ...
  url: z.string().url().describe("URL of a relevant YouTube video. Try to find a short, explanatory video if possible. Ensure this is a valid URL format."),
