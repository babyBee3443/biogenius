...
const defaultArticleTemplates: Template[] = [
    ...
    {
        id: 'listicle', name: 'Listeleme Makalesi', description: 'Belirli bir konuda numaralı veya madde işaretli öneriler/bilgiler sunan format.', previewImageUrl: 'https://placehold.co/300x200.png', type: 'article', category: 'Biyoloji',
        blocks: [ { id: generateId(), type: 'heading', level: 2, content: '[Sayı] Adımda [Konu Başlığı]' }, { id: generateId(), type: 'text', content: 'Bu listeleme makalesinde, [konu] hakkında bilmeniz gereken [sayı] önemli noktayı/adımı/öneriyi bulacaksınız.' }, { id: generateId(), type: 'image', url: 'https://placehold.co/800x400.png', alt: 'Listeleme Makalesi Konsept Görseli', caption: 'Her adımda yeni bir bilgi keşfedin.' }, { id: generateId(), type: 'heading', level: 3, content: '1. [İlk Madde/Adım Başlığı]' }, { id: generateId(), type: 'text', content: 'İlk maddenin veya adımın detaylı açıklaması. Neden önemli olduğunu veya nasıl uygulanacağını belirtin.' }, { id: generateId(), type: 'heading', level: 3, content: '2. [İkinci Madde/Adım Başlığı]' }, { id: generateId(), type: 'text', content: 'İkinci maddenin açıklaması. Örnekler veya ek bilgilerle zenginleştirin.' }, { id: generateId(), type: 'divider' }, { id: generateId(), type: 'heading', level: 3, content: '3. [Üçüncü Madde/Adım Başlığı]' }, { id: generateId(), type: 'text', content: 'Üçüncü maddenin detayları.' }, { id: generateId(), type: 'video', url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', youtubeId: 'dQw4w9WgXcQ'}, { id: generateId(), type: 'text', content: 'Listeleme makalesinin sonunda genel bir özet veya ek tavsiyeler sunabilirsiniz.' }, ],
    ...
    {
        id: 'image-gallery-article', name: 'Görsel Galerisi', description: 'Görsellerin ön planda olduğu, açıklamalı ve tematik galeri düzeni.', previewImageUrl: 'https://placehold.co/300x200.png', type: 'article', category: 'Biyoloji',
        blocks: [ { id: generateId(), type: 'heading', level: 2, content: '[Konu] Görsel Galerisi' }, { id: generateId(), type: 'text', content: 'Bu galeride [konu] ile ilgili etkileyici görselleri bir araya getirdik. Her bir görsel, konunun farklı bir yönünü aydınlatıyor.' }, { id: generateId(), type: 'image', url: 'https://placehold.co/800x500.png', alt: '[Konu] ile ilgili Görsel 1', caption: 'Görsel 1 Açıklaması: Bu görselde [detay] vurgulanmaktadır.' }, { id: generateId(), type: 'divider' }, { id: generateId(), type: 'image', url: 'https://placehold.co/800x500.png', alt: '[Konu] ile ilgili Görsel 2', caption: 'Görsel 2 Açıklaması: Burada [farklı bir detay] görebilirsiniz.' }, { id: generateId(), type: 'divider' }, { id: generateId(), type: 'image', url: 'https://placehold.co/800x500.png', alt: '[Konu] ile ilgili Görsel 3', caption: 'Görsel 3 Açıklaması: [Ek bir perspektif].' }, { id: generateId(), type: 'text', content: 'Umarız bu görsel galeri [konu] hakkındaki anlayışınızı derinleştirmiştir.' }, ],
     ...
     {
        id: 'faq-article', name: 'SSS Makalesi', description: 'Belirli bir konudaki sıkça sorulan sorulara net cevaplar veren format.', previewImageUrl: 'https://placehold.co/300x200.png', type: 'article', category: 'Biyoloji',
    ...
    {
        id: 'how-to-guide', name: 'Nasıl Yapılır Rehberi', description: 'Belirli bir işlemi adım adım anlatan, öğretici içerikler için ideal.', previewImageUrl: 'https://placehold.co/300x200.png', type: 'article', category: 'Biyoloji',
        blocks: [ { id: generateId(), type: 'heading', level: 2, content: '[İşlem/Konu] Nasıl Yapılır: Adım Adım Rehber' }, { id: generateId(), type: 'text', content: 'Bu rehberde, [işlem/konu] adım adım nasıl gerçekleştireceğinizi öğreneceksiniz. Başlangıç seviyesinden ileri seviyeye kadar herkesin faydalanabileceği pratik bilgiler içerir.' }, { id: generateId(), type: 'image', url: 'https://placehold.co/700x300.png', alt: '[İşlem/Konu] ile ilgili bir görsel', caption: 'Gerekli malzemeler veya sürecin bir aşaması.' }, { id: generateId(), type: 'heading', level: 3, content: 'Adım 1: Hazırlık' }, { id: generateId(), type: 'text', content: '[İlk adımın detaylı açıklaması. Gerekli malzemeler, ön bilgiler veya dikkat edilmesi gerekenler.]' }, { id: generateId(), type: 'heading', level: 3, content: 'Adım 2: Uygulama' }, { id: generateId(), type: 'text', content: '[İkinci adımın açıklaması. İşlemin nasıl yapılacağı, püf noktaları.]' }, { id: generateId(), type: 'image', url: 'https://placehold.co/500x250.png', alt: 'Adım 2 Görseli', caption: 'İkinci adımın görselleştirilmiş hali.'}, { id: generateId(), type: 'heading', level: 3, content: 'Adım 3: Kontrol ve Sonuç' }, { id: generateId(), type: 'text', content: '[Son adımın açıklaması. Sonuçların nasıl değerlendirileceği, olası sorunlar ve çözümleri.]' }, { id: generateId(), type: 'video', url: 'https://www.youtube.com/watch?v=A_gAJ_L4p1A', youtubeId: 'A_gAJ_L4p1A' }, { id: generateId(), type: 'text', content: 'Bu rehberle [işlem/konu] artık sizin için çok daha kolay olacak. Başarılar!' }, ],
     ...
     {
        id: 'interview-article', name: 'Röportaj Makalesi', description: 'Bir uzmanla yapılan söyleşiyi soru-cevap formatında detaylı bir şekilde sunar.', previewImageUrl: 'https://placehold.co/300x200.png', type: 'article', category: 'Biyoloji',
        blocks: [ { id: generateId(), type: 'heading', level: 2, content: '[Uzman Adı] ile [Konu] Üzerine Özel Röportaj' }, { id: generateId(), type: 'text', content: '[Konu] alanındaki uzmanlığıyla tanınan [Uzman Adı] ile [konu]nun dünü, bugünü ve yarını hakkında keyifli bir söyleşi gerçekleştirdik.' }, { id: generateId(), type: 'image', url: 'https://placehold.co/600x400.png', alt: '[Uzman Adı]', caption: '[Uzman Adı], [Unvanı]' }, { id: generateId(), type: 'heading', level: 3, content: 'Soru: [İlk Röportaj Sorusu]' }, { id: generateId(), type: 'quote', content: '[Uzmanın ilk soruya verdiği cevap. Önemli noktaları vurgulayabilirsiniz.]', citation: '[Uzman Adı]' }, { id: generateId(), type: 'divider' }, { id: generateId(), type: 'heading', level: 3, content: 'Soru: [İkinci Röportaj Sorusu]' }, { id: generateId(), type: 'quote', content: '[Uzmanın ikinci soruya verdiği cevap. Farklı bir bakış açısı veya derinlemesine bilgi.]', citation: '[Uzman Adı]' }, { id: generateId(), type: 'text', content: 'Röportajın devamında [ek konulara] da değinildi. Bu keyifli söyleşi için [Uzman Adı]\'na teşekkür ederiz.' }, ],
...
const defaultNoteTemplates: Template[] = [
    {
        id: 'standard-note', name: 'Standart Not Şablonu', description: 'Başlık, özet, anahtar kavramlar ve detaylı açıklamalar için temel not düzeni.', previewImageUrl: 'https://placehold.co/300x200.png', type: 'note', category: 'Biyoloji',
        blocks: [ { id: generateId(), type: 'heading', level: 2, content: 'Konu Başlığı' }, { id: generateId(), type: 'text', content: 'Konunun genel bir özeti veya giriş cümlesi.' }, { id: generateId(), type: 'heading', level: 3, content: 'Anahtar Kavramlar' }, { id: generateId(), type: 'text', content: '- Kavram 1\n- Kavram 2\n- Kavram 3' }, { id: generateId(), type: 'image', url: 'https://placehold.co/600x300.png', alt: 'Konuyla ilgili şema veya görsel', caption: 'Görsel açıklaması.' }, { id: generateId(), type: 'heading', level: 3, content: 'Detaylı Açıklamalar' }, { id: generateId(), type: 'text', content: 'Konunun daha derinlemesine açıklamaları, örnekler ve önemli detaylar.' }, { id: generateId(), type: 'quote', content: 'Konuyla ilgili önemli bir alıntı veya tanım.', citation: 'Kaynak (isteğe bağlı)' }, ],
    ...
    {
        id: 'process-explanation-note', name: 'Süreç Açıklama Notu', description: 'Bir biyolojik süreci adım adım açıklayan, şemalar ve görsellerle desteklenmiş not düzeni.', previewImageUrl: 'https://placehold.co/300x200.png', type: 'note', category: 'Biyoloji',
        blocks: [ { id: generateId(), type: 'heading', level: 2, content: '[Süreç Adı]' }, { id: generateId(), type: 'text', content: '[Sürecin genel bir özeti veya amacı.]' }, { id: generateId(), type: 'image', url: 'https://placehold.co/700x350.png', alt: '[Süreç] genel bakış şeması', caption: 'Sürecin aşamalarını gösteren genel bir şema.' }, { id: generateId(), type: 'heading', level: 3, content: 'Adım 1: [Adımın Adı]' }, { id: generateId(), type: 'text', content: '[Adımın açıklaması.]' }, { id: generateId(), type: 'image', url: 'https://placehold.co/500x250.png', alt: 'Adım 1 Detay Görseli'},{ id: generateId(), type: 'divider' }, { id: generateId(), type: 'heading', level: 3, content: 'Adım 2: [Adımın Adı]' }, { id: generateId(), type: 'text', content: '[Adımın açıklaması.]' }, { id: generateId(), type: 'image', url: 'https://placehold.co/500x250.png', alt: 'Adım 2 Detay Görseli'},{ id: generateId(), type: 'divider' }, { id: generateId(), type: 'heading', level: 3, content: '[... Diğer Adımlar ...]' }, { id: generateId(), type: 'text', content: '[Sürecin sonucu veya önemi.]' }, ],
...
const defaultPageTemplates: Template[] = [
    {
        id: 'standard-page', name: 'Standart Sayfa', description: 'Genel amaçlı sayfalar için başlık, metin ve görsel içeren temel düzen.', previewImageUrl: 'https://placehold.co/300x200.png', type: 'page', category: 'Genel Sayfa',
        blocks: [ { id: generateId(), type: 'heading', level: 1, content: 'Sayfa Başlığı' }, { id: generateId(), type: 'text', content: 'Bu sayfa için giriş metni veya genel açıklama.' }, { id: generateId(), type: 'image', url: 'https://placehold.co/800x400.png', alt: 'Sayfa Ana Görseli', caption: 'Görsel açıklaması.' }, { id: generateId(), type: 'heading', level: 2, content: 'Alt Başlık' }, { id: generateId(), type: 'text', content: 'Alt başlıkla ilgili detaylı içerik.' }, ]
    },
    {
        id: 'contact-page', name: 'İletişim Sayfası', description: 'İletişim formu ve iletişim bilgileri için düzenlenmiş sayfa yapısı.', previewImageUrl: 'https://placehold.co/300x200.png', type: 'page', category: 'Genel Sayfa',
