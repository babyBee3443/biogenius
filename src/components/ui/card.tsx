...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border border-border/50 bg-card text-card-foreground shadow-sm", // Reduced border opacity, kept subtle shadow
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  // Using h3 by default for CardTitle, can be overridden
  <h3
    ref={ref}
    className={cn(
